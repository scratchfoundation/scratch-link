...
JQ_SCRIPT=".version = \"${MARKETING_VERSION}.${CURRENT_PROJECT_VERSION}\"|.version_name = \"${MARKETING_VERSION}\""
...
echo "Injected version=${MARKETING_VERSION}.${CURRENT_PROJECT_VERSION} into ${SCRIPT_INPUT_FILE_0}"
